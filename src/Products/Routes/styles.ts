...
export default StyleSheet.create({
  ...
  productImg: { width: 64, height: 64, borderRadius: 10, backgroundColor: Colors.background },
  ...
  productName: { flex: 1, fontSize: 14, fontWeight: '700', color: Colors.textPrimary },
  productCat: { fontSize: 11, color: Colors.textMuted, marginTop: 2 },
  productBrand: { fontSize: 11, color: Colors.textSecondary, marginTop: 1, fontWeight: '600' },
  badgeRow: {
    flexDirection: 'row',
    alignItems: 'center',
    flexWrap: 'wrap',
  ...
  confirmText: { fontSize: 13, color: Colors.textSecondary, lineHeight: 20, marginBottom: 18 },
  ...
  detailImg: { width: 84, height: 84, borderRadius: 14, backgroundColor: Colors.background },
