...
export default StyleSheet.create({
  ...
  inputField: { flex: 1, fontSize: 16, fontWeight: '500', color: Colors.textPrimary },
  ...
  errorText: { fontSize: 12, fontWeight: '500', color: Colors.error, marginTop: 6, marginLeft: 2 },
  apiErrorBox: {
  ...
  signInText: { fontSize: 13, color: Colors.textSecondary, fontWeight: '500' },
  signInAccent: { fontSize: 13, color: Colors.primary, fontWeight: '700' },
});
